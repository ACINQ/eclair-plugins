# Contributing to eclair plugins
...
If you're looking for somewhere to start contributing, check out the [issues](https://github.com/ACINQ/eclair-plugins/issues) list.
Another way to start contributing is by adding tests or improving them.

## Communicating

We recommend using the [discussions](https://github.com/ACINQ/eclair-plugins/discussions).
...
You can also use Github issues for feature requests.
...
stable successful outcome; we use continuous integration techniques and having a stable build
...
We keep a clean commit history on the master branch with well-formed commit messages.
